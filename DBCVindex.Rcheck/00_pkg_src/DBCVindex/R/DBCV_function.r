...
#' @export
#' @import ape vegan emstreeR devtools
...
#'
#' @param G list of four elements: number of vertices, MST_edges (matrix of edges),  MST_degrees (array of numbers), MST_parent (array of numbers)
...
#'
#' d_ucore_cl[objcl] <- mr$d_ucore
#' G <- list(no_vertices = nuobjcl, MST_edges = matrix(0, nrow = nuobjcl - 1, ncol = 3), MST_degrees = rep(0, nuobjcl), MST_parent = rep(0, nuobjcl))
#' g_start <- 1
#'
